            ...
            >
              <ul class="navbar-nav navbar-nav-right">
                <li class="nav-item nav-profile dropdown">
                  <a class="nav-link" @click="Logout" href="#"> Keluar </a>
                </li>
              </ul>
              <button
                class="
      ...
      <footer class="footer">
        <div class="w-100 clearfix">
          <span
            ...
            "
            >Copyright © 2019
            <a href="http://www.urbanui.com/" target="_blank">Moklet</a>. All
      ...
      axios
        ...
        .then((response) => {
          if (response.data.success == true) {
            ...
            //get nama outlet
            axios
              .get(base_url + "/outlet/" + response.data.data.id_outlet, conf)
              .then((response2) => {
